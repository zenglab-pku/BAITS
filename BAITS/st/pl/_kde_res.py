...
def kde_res(adata_tmp, score_name, figsize=(12, 4), spot_size=50):
    """
    ...
    axes[1].set_title("Filtered regions with score")
    ...
    axes[2].matshow(mask, cmap=ListedColormap(['silver', 'indianred']))
